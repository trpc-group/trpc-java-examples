...
public class HelloServiceImplG extends HelloServiceBaseImpl implements HelloAPI {

    private static final Logger logger = LoggerFactory.getLogger(HelloServiceImplG.class);
