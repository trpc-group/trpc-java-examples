...
public class HelloServiceImplD extends HelloServiceBaseImpl implements HelloAPI {

    private static final Logger logger = LoggerFactory.getLogger(HelloServiceImplD.class);
